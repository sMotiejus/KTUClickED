...
<HTML>
	<body class="pabaiga">
		...
		<p style="z-index:3;position: absolute;top: 47%;left: 50%;transform: translate(-50%, -50%);font-size: 60px;color: black;"><?php echo $informacija['vardas'];?></p>
		<img style="position:absolute;width:auto;height:80%;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="foto/_notes/Diplomas.png"></img>
